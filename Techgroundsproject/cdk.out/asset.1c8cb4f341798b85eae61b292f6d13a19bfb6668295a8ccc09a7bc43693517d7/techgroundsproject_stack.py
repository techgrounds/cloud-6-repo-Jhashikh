...
class TechgroundsprojectStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
       ...
       # Natgateway and Elastic Id allocation to enable connection of webserver to outside world.
        cfn_nat_gateway = ec2.CfnNatGateway(self, 'NatGateway',
            subnet_id='subnetId',
       ...
       # Instance role and SSM Managed policy
        ...
        alb_SG = ec2.SecurityGroup(self, 'SecurityGroup',
            vpc= self.vpc1, 
